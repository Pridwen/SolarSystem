...
public class Puppet extends GLCanvas implements GLEventListener, KeyListener {
    ...
    public Puppet(int width, int height, GLCapabilities capabilities) {
        super(capabilities);
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        animator.start();
        String MercuryTex = "src/Textures/mercurymap.jpg";
        ...
        skyTexture = getObjectTexture(gl, StarlightTex);
